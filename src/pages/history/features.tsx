...
const FeaturesHistoryPage : React.FC<PageProps> = ({ className }) => (
    <article className={ `features-history-page ${ className }` }>
        ...
        <table>
            ...
            <tbody>
                <TRow><TCol><b>1.</b></TCol><TCol>Initial release of Svelte v5+ compatible <Anchor to="https://eagleeye.js.org/">Eagle Eye</Anchor> based state management system.</TCol></TRow>
